...
router.post('/bookings/:code/refund', requireTravelerAuth, pages.requestRefund);
router.get('/bookings/:code/invoice', requireTravelerAuth, pages.downloadInvoice);
router.get('/bookings/:code/credit-note', requireTravelerAuth, pages.downloadCreditNote);
