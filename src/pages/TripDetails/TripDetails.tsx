  ...
  return (
    ...
    >
          ...
          <div className='flex flex-col gap-3 lg:gap-7.5'>
            ...
            <div className='w-full flex flex-col lg:flex-row gap-6.5'>
              <div className='w-full lg:w-[calc(100%-441px)] flex flex-col gap-7.5'>
                <div className='flex items-center flex-wrap gap-3 sm:gap-7.5'>
                  <p className="text-[#122445] capitalize">
                    <span className="font-semibold text-2xl lg:text-[30px] leading-10.25">8,500 EGP</span>
                    <span className="text-sm md:text-base leading-4.75">/Night 10,000 EGP</span>
                  </p>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <p className='text-base sm:text-lg leading-7.5 text-black'>
                    Trip Type: <span className='font-normal text-lg leading-6.75 text-black'>Leisure / Beach</span>
                  </p>
                </div>
                <div className='flex flex-col gap-2'>
                  <div className='flex items-center gap-2.5'>
              ...
              <div className='flex flex-col items-center gap-4 w-full sm:w-103.75 bg-white shadow-[0_0_6.3px_rgba(38,56,89,0.24)] rounded-[18px] mx-auto'>
                <div className='w-full flex items-center p-4 gap-2.5 bg-[rgba(239,119,34,0.06)] border-2 border-[#EF7722] rounded-2xl box-border'>
                  ...
                  <div className='w-full'>
                    <div className='min-h-28 flex gap-4'>
                      ...
                      <div className='flex flex-col gap-1'>
                        <h4 className='font-sans font-normal text-base leading-6 text-[#122445]'>
                          Day 1 – Arrival
                        </h4>
                        <p className='font-sans font-normal text-sm leading-5 text-[#535353]'>
                          Arrival, hotel check-in, and free time.
                        </p>
                      </div>
                    </div>
                    <div className='min-h-28 flex gap-4'>
                      ...
                      <div className='flex flex-col gap-1'>
                        ...
                        <p className='font-sans font-normal text-sm leading-5 text-[#535353]'>
                          Snorkeling trip and beach time.
                        </p>
                      </div>
                    </div>
                    <div className='min-h-28 flex gap-4'>
      ...
      <TripsSection
        title2='Recommended'
        title3='for You'
        description='Trips selected based on what you might like'
        actionText='see more'
      >
        <TripsCarousel>
          {trips.map(tripItem => (
