              ...
              <DropdownMenu open={isLangMenuOpen} onOpenChange={setIsLangMenuOpen}>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    ...
                    <span className="text-center justify-start text-white text-sm font-normal font-['Inter'] leading-5">
              ...
              {!authenticated && (
                <DropdownMenu>
                  ...
                  >
                    ...
                    <Link
                      to="/profile"
                      className="w-full px-2 py-1 flex items-center gap-2 hover:bg-slate-100 rounded-md cursor-pointer"
                    >
                    ...
                    {/* Saved */}
                    <button className="w-full px-2 py-1 flex items-center gap-2 hover:bg-slate-100 rounded-md cursor-pointer">
                      <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="none">
                        <path d="M4.19444 0.5C2.15433 0.5 0.5 2.22824 0.5 4.35947C0.5 8.625 7.5 13.5 7.5 13.5C7.5 13.5 14.5 8.625 14.5 4.35947C14.5 1.71894 12.8457 0.5 10.8056 0.5C9.35889 0.5 8.10667 1.36871 7.5 2.63353C6.89333 1.36871 5.64111 0.5 4.19444 0.5Z" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                      <span className="text-black text-sm capitalize">
                        saved
                      </span>
