            ...
            <span className="checkbox-wrapper relative">
                ...
                <>
                    <svg
                        ...
                        className="h-3 w-3 stroke-neutral fill-white opacity-0 transition-opacity peer-checked:opacity-100 pointer-events-none absolute top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 mt-[1.25px]"
                        viewBox="0 0 20 20"
                    >
                        <path
                            fillRule="evenodd"
