...
interface FiltersHandlers {
  ...
  setGuestsCount: (value: string) => void
}
                  ...
                  <div className="w-full flex flex-col justify-start items-start gap-4 flex-wrap">
                    ...
                    <div className="w-full flex flex-col justify-start items-start gap-2">
                      ...
                      <DatePicker
                        ...
                        className={cn(
                          "w-full bg-neutral-100 rounded-lg inline-flex justify-between items-center text-black placeholder:text-black text-base cursor-pointer",
                          bgInput
                        )}
              ...
              <div className="flex flex-col justify-start items-start gap-2">
                ...
                {/* <Popover>
                  <PopoverTrigger asChild>
                    <button
                      className={cn(
                      "w-48 pl-5 pr-3 py-3 bg-neutral-100 rounded-lg inline-flex justify-between items-center text-black placeholder:text-black text-base cursor-pointer",
                      bgInput
                    )}
                    >
                      <span>
                  ...
                  <PopoverContent className="p-0 w-auto bg-transparent">
                    <div className="relative">
                      ...
                      <button
                        onClick={() => {}}
                        className="absolute bottom-4 right-4 px-4 py-2 bg-[#263859] text-white rounded-lg"
                      >
                        {t("shared.apply", "Apply")}
                      </button>
                    </div>
                  </PopoverContent>
                </Popover> */}
                ...
                <DatePicker
                  placeholder="Pick a date"
                  className={cn(
                    "w-48 bg-neutral-100 rounded-lg inline-flex justify-between items-center text-black placeholder:text-black text-base cursor-pointer",
                    bgInput
                  )}
                  onChange={(e)=>setDate(e as Date)}
                  value={date}
              ...
              <div className="inline-flex flex-col justify-start items-start gap-2">
                ...
                <div className="inline-flex gap-1.5">
                  <Input
                    placeholder={t("filter.from" ,"from")}
                    className={cn(
                      "w-24 h-12 bg-neutral-100 rounded-lg text-center border-0 text-black placeholder:text-black text-base font-normal capitalize",
                      bgInput
                    )}
                  />
                  <Input
              ...
              <div className="inline-flex flex-col justify-start items-start gap-2">
                ...
                <div className="inline-flex gap-1.5">
                  <Input
                    placeholder={t("filter.from" ,"from")}
                    className={cn(
                      "w-24 h-12 bg-neutral-100 rounded-lg text-center border-0 text-black placeholder:text-black text-base font-normal font-['Poppins'] capitalize",
                      bgInput
                    )}
                  />
                  <Input
